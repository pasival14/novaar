...
import aphro from '../../assets/APHRODITE/6.bmp'
    ...
    return ( 
        <div className=" bg-gray-800 text-white">
            ...
            <div className='bg-gray-800 p-6'>
                <div>
                    <h2 className='text-3xl flex justify-center items-center pt-3'>Featured Project</h2>
                    <h1 className='text-6xl my-3'>APHRODITE</h1>
                    <hr />
                </div>
                <div>
                    <div className='inset-0'>
                        <img src={aphro} alt="" className='inset-0' />
                    </div>
                </div>
            </div>
            <div 
